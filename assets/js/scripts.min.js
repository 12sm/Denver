...
1  Watch 
  Star 6
 Fork 1,524leftstick/onepage-scroll
forked from peachananr/onepage-scroll
 branch: master  onepage-scroll / jquery.onepage-scroll.js
Howard.Zuoleftstick on Jul 16 new feature by which developer can set vertical response fallback
4 contributors Howard.ZuoPete R.philLipis
390 lines (333 sloc)  16.739 kb RawBlameHistory   
/* ===========================================================
...
*/
function RepositionNav(){var n=$(window).height(),t=$("#nav").height()/2,o=n/2,e=o-t;jQuery("#nav").css({top:e})}!function(n){n.fn.parallax=function(t,o,e,i){function c(t,o){o.each(function(){var o=n(this),e=o.offset().top;if(1==i)var c=o.outerHeight(!0);else var c=o.height();e+c>=t&&t>e+c-h&&u(t,c),t>=e&&e+c>=t&&t>e-h&&e+c-h>t&&u(t,c),e+c>t&&t>e-h&&e>t&&u(t,c)})}function l(n,t,o,e,i){return n+" "+Math.round(-(t+o-e)*i)+"px"}function u(n,i){a.css({backgroundPosition:l(t,i,n,o,e)})}var r=n(window),h=n(window).height(),a=(r.scrollTop(),n(this));null==t&&(t="50%"),null==o&&(o=0),null==e&&(e=.1),null==i&&(i=!0),height=a.height(),a.css({backgroundPosition:l(t,i,o,e)}),r.bind("scroll",function(){var t=r.scrollTop();c(t,a),n("#pixels").html(t)})}}(jQuery),function(n){function t(){var t=window.innerHeight,o=document.compatMode;return(o||!n.support.boxModel)&&(t="CSS1Compat"==o?document.documentElement.clientHeight:document.body.clientHeight),t}n(window).scroll(function(){var o=t(),e=document.documentElement.scrollTop?document.documentElement.scrollTop:document.body.scrollTop,i=[];n.each(n.cache,function(){this.events&&this.events.inview&&i.push(this.handle.elem)}),i.length&&n(i).each(function(){var t=n(this),i=t.offset().top,c=t.height(),l=t.data("inview")||!1;e>i+c||i>e+o?l&&(t.data("inview",!1),t.trigger("inview",[!1])):i+c>e&&(l||(t.data("inview",!0),t.trigger("inview",[!0])))})}),n(function(){n(window).scroll()})}(jQuery);
